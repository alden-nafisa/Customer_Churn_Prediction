...
export const featureDominance = [
  { label: 'nps_trend', value: 85 },
  { label: 'is_on_time_sum', value: 72 },
  { label: 'feature_adoption_pct_mean', value: 65 },
  { label: 'churned', value: 50 },
  { label: 'ensemble_prediction', value: 45 },
  { label: 'cat_proba', value: 38 },
  { label: 'xgb_proba', value: 30 },
  { label: 'ensemble_proba', value: 25 },
  { label: 'actual', value: 15 },
]
...
export const popupDataStore = {
  paymentDelay: {
    title: 'SEGMENT: PAYMENT DELAY DRIVERS (45%)',
    subtitle: 'Ditemukan 124 Pelanggan berisiko karena telat bayar.',
    data: [
    ...
    col3Label: 'Delay Days',
    actionLabel: 'Load Data',
  },
  forecast: {
    title: 'FORECAST: PREDICTED CHURN (NOV 2026)',
    subtitle: 'Ditemukan 85 Pelanggan dengan probabilitas churn > 70% bulan depan.',
    data: [
    ...
    col3Label: 'Churn Prob.',
    actionLabel: 'Load Data',
    hasCol4: true,
    col4Label: 'Est. Loss',
  },
  enterpriseMrr: {
    title: 'SEGMENT: ENTERPRISE AT-RISK MRR ($12.5k)',
    subtitle: 'Ditemukan 12 Pelanggan Enterprise berisiko tinggi bulan ini.',
    data: [
    ...
    actionLabel: 'Load Data',
    hasCol4: true,
    col4Label: 'MRR at Risk',
  },
  technicalIssues: {
    title: 'SUPPORT: UNRESOLVED TECHNICAL ISSUES (60%)',
    subtitle: 'Ditemukan 45 Tiket Teknis Terbuka dari pelanggan berisiko tinggi.',
    data: [
    ...
    col2Label: 'Ticket ID',
    col3Label: 'Priority',
    actionLabel: 'View Tkt',
    hasCol4: true,
    col4Label: 'Days Unresolved',
  },
}
