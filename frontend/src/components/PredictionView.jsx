...
export default function PredictionView() {
  ...
  const handleFetch = () => {
    ...
    setTimeout(() => {
      ...
      setFormData({
        paymentDelay: '1', lastLogin: '30', dunning: '5', nps: '3', ticketRatio: '1', revAtRisk: '$ 112.58'
      })
    }, 1000)
  }
  ...
  const handlePredict = () => {
    ...
    setTimeout(() => { setPredictState('predicted') }, 1500)
  }
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative w-40">
              ...
              >
                ...
                <option value="0011">C-0011</option>
              </select>
          ...
          <div className="flex items-center gap-4">
            {fetchState === 'fetched' && (
              <div className="flex items-center gap-2 bg-slate-50 px-4 py-1.5 rounded-full border border-slate-100 animate-in fade-in">
                <span className="text-[13px] font-bold text-slate-700">C-0011 | Acropolis LLC | Starter | Monthly | </span>
                <span className="bg-rose-400 text-white text-[10px] font-black px-2 py-0.5 rounded shadow-sm">CHURNED</span>
              </div>
            )}
          ...
          <div className="p-4 space-y-4 flex-1 flex flex-col overflow-y-auto">
            <div className="border border-slate-200 rounded-xl p-3 flex gap-3 relative overflow-hidden bg-slate-50/50">
              ...
              <div className="flex-1 space-y-3">
                ...
                <div className="flex items-center gap-2"><span className="text-[9px] font-bold text-slate-500 uppercase">Probability</span><span className="bg-rose-400 text-white text-[11px] font-black px-2 py-0.5 rounded shadow-sm">82.5%</span></div>
                <div className="flex items-center gap-2 mt-1"><span className="text-[9px] font-bold text-slate-500 uppercase">Status</span><span className="bg-rose-400 text-white text-[10px] font-black px-2 py-0.5 rounded shadow-sm">HIGH - RISK</span></div>
              </div>
            </div>
          </div>
        </div>
